        ...
        <div className="flex flex-col justify-center py-14 md:pr-16 xl:pr-40 md:py-0">
          <div className="text-center md:text-left space-y-6">
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="flex gap-3 justify-center md:justify-start !mt-8 items-center"
            >
              <Button className="hover:bg-primary/80">Get Started</Button>
              <Button className="bg-transparent flex justify-end items-center gap-2 font-semibold">
                <span className="size-10 bg-secondary/15 rounded-full flex justify-center items-center">
